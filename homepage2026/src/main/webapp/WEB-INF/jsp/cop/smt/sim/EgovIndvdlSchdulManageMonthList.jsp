    ...
    ******************************************************** */
    ...
    function resizeFrame(re) {
        ...
        if(ifr){
			...
			//주석제거시 다음 구문으로 교체 -> if (ifr.style.height != innerHeight || ifr.style.width != innerWidth)
							  	...
							  	<div class="sf_start">
							  		<ul id="search_first_ul">
							  			...
							  			<li>
								            ...
								            <a href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageMonthList' />?year=<%=year-1%>&amp;month=<%=month%>"
								            ...
								            <%if(month > 0 ){ %>
								            <a href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageMonthList' />?year=<%=year%>&amp;month=<%=month-1%>"
