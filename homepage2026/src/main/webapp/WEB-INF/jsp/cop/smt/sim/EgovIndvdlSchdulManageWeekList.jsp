                                ...
                                <div class="sf_start">
                                    <ul id="search_first_ul">
                                        ...
                                        <li>
								            ...
								            <img alt="이전년도로 이동" src="<c:url value='/images/btn/btn_prev.gif'/>" align="middle" style="margin-right:4px;border:0px;">
								            </a>
								            <%=iNowYear%>년
								            <a href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.do' />?year=<%=iNowYear+1%>&amp;month=<%=iNowMonth%>&amp;week=<%=iNowWeek%>"
								               onclick="fnSchduleSearch('<%=iNowYear+1%>','<%=iNowMonth%>','<%=iNowWeek%>'); return false;">
								            <img alt="다음년도로 이동" src="<c:url value='/images/btn/btn_next.gif'/>" align="middle" style="margin-left:4px;border:0px;">
								            </a>&nbsp;&nbsp;&nbsp;
								            <%if(iNowMonth > 0 ){ %>
								            <a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageWeekList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth-1%>&amp;week=<%=0%>"
								               onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth-1%>','<%=iNowWeek%>'); return false;">
								            <img alt="이전월로 이동" src="<c:url value='/images/btn/btn_prev.gif'/>" align="middle" style="margin-right:4px;border:0px;">
								            </a>
								            <%}%>
								            <%=iNowMonth+1%>월
								            <%if(iNowMonth < 11 ){ %>
								            <a href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth+1%>&amp;week=<%=0%>"
								               onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth+1%>','<%=iNowWeek%>'); return false;">
								            <img alt="다음월로 이동" src="<c:url value='/images/btn/btn_next.gif'/>" align="middle" style="margin-left:4px;border:0px;">
								            </a> 
								            <%}%>&nbsp;&nbsp;&nbsp;
								            <%if(iNowWeek > 0 ){ %>
								            ...
								            <img alt="이전날짜로 이동" src="<c:url value='/images/btn/btn_prev.gif'/>" align="middle" style="margin-right:4px;border:0px;">
								            </a>
								            <%}%>
								            <%=iNowWeek+1%>주
								            ...
								            <a href="<c:url value='/cop/smt/sim/EgovIndvdlSchdulManageWeekList.do' />?year=<%=iNowYear%>&month=<%=iNowMonth%>&week=<%=iNowWeek+1%>"
								               onclick="fnSchduleSearch('<%=iNowYear%>','<%=iNowMonth%>','<%=iNowWeek+1%>'); return false;">
								            <img alt="다음날짜로 이동" src="<c:url value='/images/btn/btn_next.gif'/>" align="middle" style="margin-left:4px;border:0px;">
								            </a> 
								            <%}%>
                                        </li>       
                                    </ul>
